    ...
    return (
        <Modal {...props} onCancel={() => {props.setShowModal(false)}} onOk={form.submit} destroyOnClose={true}>
            <Form layout='vertical' form={form} onFinish={onSubmit}>
                ...
                <Form.Item name='name' label='Nome do serviço' rules={[{required: true, message: 'Insira um nome para o serviço'}]}>
                    <Input placeholder='Insira o nome do serviço'></Input>
                </Form.Item>
                <Form.Item name='price' label='Preço'>
                    <Input placeholder='Insira o preço do serviço'></Input>
                </Form.Item>
            </Form>
        </Modal>
    );
...
export default RegistrarServiço;